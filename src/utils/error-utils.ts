...
>([
  ...
  [KeyError.unownedKey, 'UnownedKey'],
  [OtherError.providerError, 'ProviderError'],
  [KeyError.noTransaction, 'NoTransaction'],
  ...
  [KeyError.nativeExceeded, 'showNativeCoinNeededMsg'],
  [KeyError.tokenNotFound, 'TokenNotFound'],
  [KeyError.walletIsBusy, 'WalletIsBusy'],
  [KeyError.transactionTimedOut, 'transactionTimeOut'],
  [OtherError.signingError, 'ProviderError'],
  [OtherError.otkSwapAlreadyDone, 'AlreadyMigratedPleaseReImport'],
